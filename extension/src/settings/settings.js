// extension/src/settings/settings.js
import { getSettings, getHistory, getReports, saveSettings, saveHistory, saveReports } from '../background/storage.js';
  ...
  $('importFile').addEventListener('change', (e) => {
    ...
    reader.onload = async (evt) => {
      try {
        ...
        if (hasSettings) await saveSettings(backup.settings);
        if (hasHistory) await saveHistory(backup.history);
        if (hasReports) await saveReports(backup.reports);
